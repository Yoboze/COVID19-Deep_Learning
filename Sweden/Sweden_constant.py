...
class PINN_constantParam:
    ...
    def __init__(self, t, I, layers, lb, ub):
        ...
        # initialize params
        self.beta = tf.Variable([80.0], dtype=tf.float32)
...
corr_matrix = np.corrcoef(I0LT, I1LT[:122])
...
mapep =  mean_absolute_percentage_error(I0LT, I1LT[:122])
print("MAPE:", mapep)

#EV
ev = (explained_variance_score(I0LT, I1LT[:122]))
print("EV:",ev)

#RMSE
RMSE = np.sqrt(mean_squared_error(I0LT, I1LT[:122]))
print("RMSE:", RMSE)
